                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <select
                                    ...
                                    className={`bg-purple-400 w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${errors.vehicleSpecId ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                >
                                ...
                                {selectedSpec && (
                                    <div className="mt-3 p-4 bg-purple-400 rounded-lg border border-purple-200">
